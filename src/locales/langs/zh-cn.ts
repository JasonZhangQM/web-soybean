const local: App.I18n.Schema = {
  ...
  route: {
    ...
    'bds_fund-balances': '资产负债表',
    'bds_fund-incomes': '利润表',
    'bills_group': '账单汇总',
    'bills_bills': '交易明细',
    'bills_profits': '账单收益',
    ...
    'irs_option': '期权监测',
    'irs_value': '估值监测',
    'irs_symbol-values': '估值配置',
    'irs_symbol-kpis': '估值指标',
    'irs_symbol-options': '期权配置',
    'irs_monitor-options': '期权监测',
    'irs_monitor-option-ts': '期权T型报价',
    'irs_symbol-discounts': '贴水配置',
    'irs_monitor-discounts': '贴水监测'
  },
  page: {
    login: {
      common: {
