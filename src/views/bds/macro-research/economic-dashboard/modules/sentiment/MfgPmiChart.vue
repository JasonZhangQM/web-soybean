...
defineOptions({ name: 'SentimentMfgPmiChart' });

/** 官方制造业 vs 财新制造业 PMI：双折线 + 50 荣枯线参考线 */
interface Props {
...
function buildOption() {
  ...
  const official = getSeries(props.dataMap, 'CN_OFFICIAL_MFG_PMI');
  const ratingdog = getSeries(props.dataMap, 'CN_RATINGDOG_MFG_PMI');
  ...
  return {
    ...
    legend: { bottom: 0, data: ['官方制造业', '财新制造业'] },
