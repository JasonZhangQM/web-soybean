...
const columns = [
  ...
  { title: '期权类型', key: 'option_type', width: 80, render: (row: Api.Irs.OptionMonitor) => fmtOptionType(row.option_type) },
  ...
  { title: '平值(%)', key: 'atm_i', width: 100, render: (row: Api.Irs.OptionMonitor) => fmt(row.atm_i) },
  { title: '时间(%)', key: 'ratio_t', width: 100, render: (row: Api.Irs.OptionMonitor) => fmt(row.ratio_t) },
  { title: '内在(%)', key: 'ratio_i', width: 100, render: (row: Api.Irs.OptionMonitor) => fmt(row.ratio_i) },
  { title: '时间(%Y)', key: 'ratio_t_y', width: 120, render: (row: Api.Irs.OptionMonitor) => fmt(row.ratio_t_y) },
  { title: '内在(%Y)', key: 'ratio_i_y', width: 120, render: (row: Api.Irs.OptionMonitor) => fmt(row.ratio_i_y) }
];
